...
doc.addImage(imgdata,70,5,80,30)
// Dibujar el texto centrado horizontalmente y verticalmente
doc.text(transurimp,xpostransur, 40, { align: "center" });
doc.text(dateTime , dataTimex,45, { align: "center" });

doc.setFontSize(15);
doc.text(nombre,90,65)
doc.text(tdoc,90,80)
doc.text(ccnumer,90,95)

doc.setFontSize(20);

doc.text(textoSeleccionado , 90,120, { align: "center" });
doc.text(texto2Seleccionado , 90,150, { align: "center" });
doc.text(paradasfimp, 90,180, { align: "center" });
doc.text(cvalorfinal, 90,210, { align: "center" });
doc.text(ccdesloca, 90,240, { align: "center" });

doc.setFontSize(14);
doc.setFontType("bold")
doc.text("Nombre y apellidos:",85,60)

doc.text("Tipo de documento:",85,75)

doc.text("Numero de documento:",80,90)

doc.text(corigenimp,xposorigen, 110, { align: "center" } );
doc.text(cdestinoimp,xposdestino, 140, { align: "center" });
doc.text(paradasimp,xposparadas, 170, { align: "center" });
doc.text(totalimp,xpostotal, 200, { align: "center" });
doc.text(ccdesimp,xposccdes, 230, { align: "center" });
